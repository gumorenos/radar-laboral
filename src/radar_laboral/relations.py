...
def list_related_norms_for_case_law(case_id: str):
    """Return norms related to one jurisprudence record in either direction."""
    with connect() as conn:
        rows = conn.execute(
            """
            SELECT n.*, dr.relation_type, dr.note,
